...
mixin _$Group {
  ...
  @override
  String toString() {
    return 'Group(id: $id, name: $name, members: $members, currency: $currency, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
}
...
extension GroupPatterns on Group {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String id, String name, List<String> members,
            String currency, DateTime createdAt, DateTime? updatedAt)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _Group() when $default != null:
        return $default(_that.id, _that.name, _that.members, _that.currency,
